...
HELP_CATEGORIES = [
    ...
    },
    {
        ...
        "items": [
            ...
            ("/upgrade", "Directly upgrades a fighter's star level by name via autocomplete — skips browsing `/collection` and jumps straight to the confirm screen. Only shows cards that have a free duplicate available."),
