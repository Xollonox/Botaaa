...
HELP_CATEGORIES = [
    ...
    },
    {
        ...
        "items": [
            ...
            ("/o delete_attack", "Owner command that deletes an attack and removes stale references from all cards."),
            ("/o list_attacks", "Owner command that lists the available attack catalog entries for quick review and maintenance."),
            ("/o assign_attack", "Owner command that assigns an existing attack to a specific card while enforcing type limits."),
            ("/o remove_attack", "Owner command that removes an assigned attack from a card without deleting it from the catalog."),
            ("/o view_card_attacks", "Owner command that shows all attacks currently assigned to a chosen card."),
        ],
    },
    {
        "name": "Owner Economy",
